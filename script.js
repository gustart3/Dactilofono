...
*/
//acá termina el codigo original
...
const scales = {
  2: {
    ...
    notes: {
      ...
      B: "G2", H: "G#2", N: "A2", J: "A#2", M: "B2", ",": "C3", L: "C#3", 
      ".": "D3", A: "D#3", Q: "E3", W: "F3", E: "F#3", R: "G3", T: "G#3", 
      Y: "A3", U: "A#3", I: "B3", O: "C4"
    },
    frequencies: {
  ...
  3: {
    ...
    notes: {
      ...
      ".": "D5", A: "D#5", Q: "E5", W: "F5", E: "F#5", R: "G5", T: "G#5", 
      Y: "A5", U: "A#5", I: "B5", O: "C6"
    },
    frequencies: {
  ...
  4: {
    label: "C6 - C8",
    notes: {
      Z: "C6", S: "C#6", X: "D6", D: "D#6", C: "E6", V: "F6", G: "F#6", 
      B: "G6", H: "G#6", N: "A6", J: "A#6", M: "B6", ",": "C7", L: "C#7", 
      ".": "D7", A: "D#7", Q: "E7", W: "F7", E: "F#7", R: "G7", T: "G#7", 
      Y: "A7", U: "A#7", I: "B7", O: "C8"
    },
    frequencies: {
      C6: 1046.5, "C#6": 1108.73, D6: 1174.66, "D#6": 1244.51, E6: 1318.51, 
      F6: 1396.91, "F#6": 1480.0, G6: 1567.98, "G#6": 1661.22, A6: 1760.0, 
      "A#6": 1864.66, B6: 1975.53, C7: 2093.0, "C#7": 2217.46, D7: 2349.32, 
      "D#7": 2489.02, E7: 2637.02, F7: 2793.83, "F#7": 2959.96, G7: 3135.96, 
      "G#7": 3322.44, A7: 3520.0, "A#7": 3729.31, B7: 3951.07, C8: 4186.01
    },
  },
};
...
function playSound(note) {
  ...
  if (!activeOscillators[note]) {
    const oscillator = audioContext.createOscillator();
    oscillator.type = "triangle"; // Cambiar a "triangle" para un sonido más suave
    oscillator.frequency.setValueAtTime(frequency, audioContext.currentTime);
...
function createReverbBuffer(audioContext) {
  ...
  for (let i = 0; i < length; i++) {
    const n = length - i;
    impulseL[i] = (Math.random() * 2 - 1) * Math.pow(n, 3) * 0.0000001;
    impulseR[i] = (Math.random() * 2 - 1) * Math.pow(n, 3) * 0.0000001;
  }
